...
namespace Overclocked
{
    ...
    public class BlockedRegenDebuff : ModBuff
    {
        ...
        {
            player.GetModPlayer<BlockedRegenDebuffPlayer>().BlockedRegenDebuff = true;
        }
    }

    public class BlockedRegenDebuffPlayer : ModPlayer
    {
        // Flag checking when life regen debuff should be activated
        public bool BlockedRegenDebuff;

        public override void ResetEffects()
        {
            BlockedRegenDebuff = false;
        }
